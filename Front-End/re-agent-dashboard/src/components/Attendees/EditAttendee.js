...
class EditAttendee extends React.Component
{
    constructor() {
      ...
      handleSubmit = (event) => {
        ...
        axios
          .put(`/attendees/${this.props.match.params.attendeeID}`, EditedAttendee)
          .then((res) => {
            console.log(res.data);
            this.setState({
              loading: false,
            });
            this.props.history.push(`/attendees/${this.state.houseID}`);
          })
          .catch((err) => {
            this.setState({
...
EditAttendee.propTypes = {
  ...
  export default withStyles(styles)(EditAttendee);